...
/**
  ...
  if (logoPath && logoContainer) {
    ...
    // 3. Start watching the logo container
    logoObserver.observe(logoContainer);
  }

  /**
   * particlesJS.load for LOGO SECTION
   * This handles request #4
   */
  // We'll just re-use the footer config
  particlesJS('logo-particles', {
    "particles": {
      "number": { "value": 30, "density": { "enable": true, "value_area": 800 } },
      "color": { "value": "#EAEAEA" },
      "shape": { "type": "polygon", "stroke": { "width": 0, "color": "#000000" }, "polygon": { "nb_sides": 6 }, "image": { "src": "img/github.svg", "width": 100, "height": 100 } },
      "opacity": { "value": 0.5, "random": false, "anim": { "enable": false, "speed": 1, "opacity_min": 0.1, "sync": false } },
      "size": { "value": 3, "random": true, "anim": { "enable": false, "speed": 19.18081918081918, "size_min": 0.1, "sync": false } },
      "line_linked": { "enable": true, "distance": 150, "color": "#EAEAEA", "opacity": 0.4, "width": 1 },
